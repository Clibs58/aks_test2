              ...
              <div className="flex flex-col md:flex-row min-h-[360px]">
                ...
                <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center border-t md:border-t-0 md:border-l border-white/10">
                  ...
                  <p className="text-lg text-white leading-relaxed mb-6">
                    AKS is a product leadership ecosystem helping student-led
                    startups build real products with clarity and structure.
                  </p>

                  <p className="text-gray-400 text-lg leading-relaxed">
                    We work as an embedded product team, supporting strategy,
                    execution, and go-to-market, while also building AKS-owned
                    SaaS products and connecting founders with industry experts.
                  </p>
                </div>
